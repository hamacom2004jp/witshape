    ...
    def get_option(self):
        ...
        return dict(
            ...
            choise=[
                ...
                dict(opt="dbname", type="str", default="postgres", required=True, multi=False, hide=True, choise=None,
                ...
                dict(opt="newdbname", type="str", default="witshape", required=False, multi=False, hide=False, choise=None,
